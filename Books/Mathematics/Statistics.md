...
<img src="../../pictures/20231218165235.png" width="170"/> 
...
<img src="../../pictures/20231218173305.png" width="300"/> 

### 两个总体比例之差的检验

$$
\hat{\sigma}_{\overline{x}_1  - \overline{x}_2} =\sqrt{\frac{s_1^2}{n_1} - \frac{s_2^2}{n_2}}\\
t的自由度 f=\frac{(\frac{s_1^2}{n_1} + \frac{s_2^2}{n_2})^2}{
